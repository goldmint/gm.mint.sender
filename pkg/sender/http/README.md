...
An event with a sending completion status.
```json
{
  ...
  "amount": "1.666...000",       // Token amount in major units (18 decimal places, empty on failure)
...
An event with an approvement status.
```json
{
  "success": true,               // Success is true in case of success
  "error": "",                   // Error contains error descrition in case of failure
